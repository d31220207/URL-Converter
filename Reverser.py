...
<body>
  ...
  <div class="container">
    <h1>URL Reverser</h1>
    <div class="subtitle">GitHub Pages, YouTube & Google Drive URL</div>
    <form method="post">
    ...
    <h2>Example</h2>
    <button class="collapsible">GitHub Pages</button>
    <div class="content">
    ...
    <button class="collapsible">YouTube</button>
    <div class="content">
      <p><span class="input">Input:</span> https://www.youtube.com/@afkarxyz or
        https://www.youtube.com/watch?v=76vbdg9Tq2E/</p>
      <p><span class="result">Result:</span> https://www.youtube.com/channel/UCLPfgkXWjm0qK479Nr1PqBg</p>
    </div>
    <button class="collapsible">Google Drive</button>
    <div class="content">
      <p><span class="input">Input:</span>
        https://drive.usercontent.google.com/download?id=0B1MVW1mFO2zmZHVRWEQ3Rkc3SVE&export=download&authuser=0</p>
